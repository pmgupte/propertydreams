            ...
            if(property_type == 'Apartment or Condo' || property_type =='Landed House' || property_type =='HDB Apartment')
                {           
                        ...
                        if(price >= 1000000000 || valuation_price >= 1000000000)//Property price==0        1 million = price
                                 {       
                                       //alert("price is too low");
                                       alert("Asking price and Valuation price should be less than 1000000000 for Propertyguru");	
                                       return false;
                                 }
                                 ...
                                 if(price_psf<50)
                                  {
                                    alert("Cannot list Sale price below S$50 psf for Propertyguru");
                                    return false;
                                  }
                              }
                }
                else
                {
                        ...
                        if(price >= 1000000000 || valuation_price >= 1000000000)//Property price==0        1 million = price
                                 {       
                                       //alert("price is too low");
                                       alert("Commercial Property Type: Asking price and Valuation price should be less than 1000000000 for Propertyguru");	
                                       return false;
                                 }                  
                }
          }            
   ...
   if(Type == "rent")
        {
         ...
         if(property_type == 'Apartment or Condo' || property_type =='Landed House' || property_type =='HDB Apartment')
            {                  
               if(price >= 1000000000)//Property price==0
                        {       
                             alert("Please enter price less than 1000000000 for Propertyguru.");	
                              return false;
                        }  
                      ...
                      price_psf=price/builtup_Area;
                        if(price_psf>50)
                         {
                             alert("Cannot list Rent price above S$50 psf for Propertyguru");
                             return false;
                         }
                     }
            }
            else
            {
                        if(price >= 1000000000 || valuation_price >= 1000000000)//Property price==0        1 million = price
                                 {       
                                       //alert("price is too low");
                                       alert("Rental Commercial Property Type: Asking price and Valuation price should be less than 1000000000 for Propertyguru");	
                                       return false;
                                 }                  
            }
         }            
...
//      }
  ...
  if(estate=="")
    {
           alert(" Estate is mandatory field on Propertyguru");	
           return false;
