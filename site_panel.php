...
if(false==checked)
	{
		...
		alert ('Please select at least one site to post the Advertisement.');
		return false;
	}
}</script>
</head>
...
<div id="content-table-inner">
 ...
 $cnt++;
                      ...
                      echo "<br>";
                      echo "<tr>";?>
		      <input id="check_<?php echo $cnt; ?>" type="checkbox" name="<?php echo $Site_Name;?>" value="<?php echo $Site_ID;?>" <?php  if(isset($_SESSION['selected_sites'])){  if(in_array($Site_Name, $_SESSION['selected_sites'])){  echo "checked=\"true\""; }}?> <?php if($Site_Username == "" || $Site_Password == ""){?>DISABLED <?php }?>/><?php echo "  ",$Site_Name;?><br />
		      <?php echo "</tr>";?>
         ...
         <?php 
				...
				echo "Fill Up the Credentails to post your AD <a href='profile_mgmt.php'>Goto My Profile Management</a>?";?>
	</tr><br><br><input type="submit" name="submit_Sites_Details" value="Next" disabled="true"/><?php
					
}else{?>
</tr><br><br><input type="submit" name="submit_Sites_Details" value="Next"/>
	<?php }?>
