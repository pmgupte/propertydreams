...
<div id="page-top">
	...
	<div id="top-search">
		...
		<select  class="styledselect">
			...
			<option value="">Ads Management</option>
...
<div class="nav-outer"> 
		...
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo">Create new add</a></li>
				<li><a href="#nogo">View Add</a></li>
		...
		<ul class="current"><li><a href="#nogo"><b>User Management</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			...
			<?php if($_SESSION['Is_Admin']=="admin")
				...
				<li class="sub_show"><a href="list_user.php">List User</a></li>
			<?php }
	                     if($_SESSION['Is_Admin']=="user")
			        {?>
				<li><a href="#nogo">Profile management</a></li>
			  	<?php}?>			 
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
