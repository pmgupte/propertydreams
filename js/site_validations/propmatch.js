   ...
   if(Type == "sale")
         {
               ...
               if(price < 100000)//Property price==0        1 lakh = price minimum including for propmatch  
                        {       
                              ...
                              alert("For Propmatch : Asking price should be more than 100,000");	
                              return false;
                        }
	       if(price > 2147483647 || valuation_price > 2147483647)//Property price==0        1 lakh = price minimum including for propmatch  
                        {       
                              //alert("price is too low");
                              alert("For Propmatch : Asking price & Valuation price should be less than 2,147,483,647");	
                              return false;
                        }
	       if(area > 2147483647)//Property price==0        1 lakh = price minimum including for propmatch  
                        {       
                              //alert("price is too low");
                              alert("For Propmatch : Land Area should be less than 2,147,483,647");	
                              return false;
                        }
	       if(builtup_Area > 2147483647)//Property price==0        1 lakh = price minimum including for propmatch  
                        {       
                              //alert("price is too low");
                              alert("For Propmatch : Built Up Area should be less than 2,147,483,647");	
                              return false;
                        }
         }
...
if(Type == "rent")
{						//checking for Type=rent if Yes Minimum_Term is mandetory
	if(Minimum_Term == "")//
		{
			alert(" Propmatch: Minimum Term required for Rent");
			return false;
		}
	if(price > 2147483647 || valuation_price > 2147483647)//Property price==0        1 lakh = price minimum including for propmatch  
                        {       
                              //alert("price is too low");
                              alert("For Propmatch : Rental Asking price & Valuation price should be less than 2,147,483,647");	
                              return false;
                        }
               if(price < 100)//Property price==0        1 lakh = price minimum including for propmatch  

                        {       
                              //alert("price is too low");
                              alert("For Propmatch : Asking price should be more than 100");	
                              return false;
                        }

	if(area > 2147483647)//Area        1 lakh = price minimum including for propmatch  
                        {       
                              //alert("price is too low");
                              alert("For Propmatch : Land Area should be less than 2,147,483,647");	
                              return false;
...
if(!IsNumeric(Minimum_Term))//Property Minimum_Term  is numeric
  {
      //alert(area);
       alert("Please enter Numeric value for Minimum Term ");
        return false;
  }
...
//       }
   ...
   if(street == "")//Validation for Street not null value 
   {
    
          alert("For Propmatch : Street is mandatory ");	
	  return false;
